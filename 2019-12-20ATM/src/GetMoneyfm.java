...
public class GetMoneyfm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GetMoneyfm frame = new GetMoneyfm(null, null);
	...
	public GetMoneyfm(final String name,final String password) {
		setResizable(false);
		setTitle("取款界面");
		...
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				new Menufm(name, password).setVisible(true);
			}
		});
